...
const Java = () => {
  ...
  return (
    <div className="body">
      <nav id="navbar">
        <button className="button-28" onClick={() => navigate(-1)}>&larr;Back</button>
        <header>JS doc</header>
        <ul>
          <li>
          ...
          <li>
            <a className="nav-link" href="#JavaScript_and_Java">
              JavaScript and Java
            </a>
          </li>
          <li>
            <a className="nav-link" href="#Hello_world">
              Hello world
            </a>
          </li>
          <li>
          ...
          <li>
            <a className="nav-link" href="#Declaring_variables">
              Declaring variables
            </a>
          </li>
          <li>
            <a className="nav-link" href="#Variable_scope">
              Variable scope
            </a>
          </li>
          <li>
            <a className="nav-link" href="#Global_variables">
              Global variables
            </a>
          </li>
          <li>
            <a className="nav-link" href="#Constants">
              Constants
            </a>
          </li>
          <li>
          ...
          <li>
            <a className="nav-link" href="#if...else_statement">
              if...else statement
            </a>
          </li>
          <li>
            <a className="nav-link" href="#while_statement">
              while statement
            </a>
          </li>
          <li>
